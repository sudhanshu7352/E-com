         ...
         <div>
            ...
            <div className="credit-card-logo" >
               ...
               <img className="credit-card-img" src="https://d36g7qg6pk2cm7.cloudfront.net/assets/diners_club-f9e57f98657b6d134bb600710e4c43c35f798acc621552e8d9cf168fb4a25988.png"
                  ...
                  <input style={{ marginLeft: "4%" }} className="form-check-input" type="radio" name="flexRadioDefault" />
                <img className="credit-card-img" src="https://d36g7qg6pk2cm7.cloudfront.net/assets/rupay-0817613f9104b0be7203a0b12910dbeac272daa38187c9e52960324532e12ba9.png" alt="" width="55px" height="25px"/>
            </div>


            <div className="card card-header">
               {error && <span style={{ color: "red" }}>{error}</span>}
               <label style={{display: "block", width:'165px',margin:'5px'}} className="cardnum">Card Number</label>
               ...
               <br />
               <label style={{display: "block", width:'190px',margin:'5px'}} className="cardnum">Name on the card</label>
